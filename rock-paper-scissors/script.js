...
const endWin = document.querySelector('.end .win');
const endLose = document.querySelector('.end .lose');
const endBtn = document.querySelector('.end .again');
...
function endResult(result) {
    ...
    if (result === 'win') {
        ...
        endLose.classList.remove('hidden');
    }
}